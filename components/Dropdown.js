...
const Dropdown = () => {
  ...
  return (
    <Menu as="div" className="w-24 h-12 relative flex items-center">
        ...
        <Menu.Button className="flex items-center w-full px-4 py-3 text-sm font-medium text-white bg-[#1A1A1A] rounded-full hover:bg-[#3E3E3E]">
          ...
          <img
            src={
              session.user.image
                ? session.user.image
                : "https://fjob.vn/assets/images/avatar/user.png"
            }
            alt=""
      ...
      >
        <Menu.Items className="absolute right-1 w-56 mt-24 origin-top-right bg-[#1A1A1A] divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
